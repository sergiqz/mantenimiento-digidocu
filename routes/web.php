...
Route::group(['prefix' => 'admin', 'middleware' => ['auth','check_block']], function () {
    ...
    Route::get('/recycle-tags', 'TagController@trash')->name('tags.trash');
    Route::get('/recycle-tags/{id}', 'TagController@restore')->name('tags.restore');
    ...
    Route::get('/recycle-documents', 'DocumentController@trash')->name('documents.trash');
    Route::get('/recycle-documents/{id}', 'DocumentController@restore')->name('documents.restore');
...
//    Route::get('image', 'ImageUploadController@index');
 //   Route::post('save', 'ImageUploadController@save')->name('image.upload.post');
});
