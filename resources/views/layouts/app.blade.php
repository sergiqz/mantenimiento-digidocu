    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{route('admin.dashboard')}}" class="hidden-xs logo">
                ...
                <span class="logo-lg"><b>Digi Document</b></span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="file-text-o" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                Language <span class="caret"></span>
                                @switch($locale)
                                @case('es')
                                <img src="{{asset('/es.png')}}" width="30px" height="20x"> Spain
                                @break
                                @default
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="lang/en"><img src="{{asset('/us.png')}}" width="30px" height="20x"> English  </a>
                                <br>
                                <a class="dropdown-item" href="lang/es"><img src="{{asset('/es.png')}}" width="30px" height="20x"> Spanish  </a>
                            </div>
                        </li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {!! Auth::user()->name !!}
                                        <small>{{ __('content.member_since') }} {!! Auth::user()->created_at->format('M. Y') !!}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('profile.manage')}}" class="btn btn-default btn-flat">{{ __('content.profile') }}</a>
                                    </div>
