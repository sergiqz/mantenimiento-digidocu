            ...
            <div class="col-md-8">
                <div class="box box-default">
                    <div class="box-header no-border text-center">
                        <h3 class="box-title">{{ __('content.quick_update') }}</h3>
                    ...
                    <div class="box-body">
                        <form action="#" class="text-center" style="width: 30vw;margin: 0 auto;" onsubmit="return gotoUpload()">
                            <div class="form-group">
                                <label for="">{{ __('content.choose_document') }}</label>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary">{{ __('content.upload') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="info-box bg-yellow">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ __('content.tags') }}</span>
                        <span class="info-box-number">{{$tagCounts}}</span>
                        <span class="progress-description">
                        {{ __('content.total_tag') }}
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <div class="info-box bg-green">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ __('content.document') }}</span>
                        <span class="info-box-number">{{$documentCounts}}</span>
                        <span class="progress-description">
                        {{ __('content.containing') }} {{$filesCounts}} {{ __('content.file') }}
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-sm-12">
                <div class="box box-default">
                    <div class="box-header no-border">
                        <h3 class="box-title">{{ __('content.activity') }}</h3>
                        ...
                        <div class="box-tools pull-right">
                            {!! Form::open(['method' => 'get','style'=>'display:inline;']) !!}
                                ...
                                <button type="button" id="activityrange" class="btn btn-default btn-sm">
                                    ...
                                    <span>{{ __('content.choose_dates') }}</span> <i class="fa fa-caret-down"></i>
                                </button>
