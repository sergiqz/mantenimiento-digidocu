...
class DocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $trash = false;  
        return view('documents.index', compact('documents', 'tags','trash'));
    }
    ...
    public function trash(Request $request)
    {
        ...
        $documentss = Document::onlyTrashed()->orderBy('deleted_at', 'asc')->get();
       $documents = $documentss->toJson();
        dd($documents);

        $tags = $this->tagRepository->all();
        $trash = true;  
        return view('documents.index', compact('documents','trash', 'tags',));
